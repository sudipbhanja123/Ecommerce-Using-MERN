  ...
  return (
    ...
    >
      <div
        ...
        style={{
          transition: "trasform 300ms cubic-brezier(0.25,0.46,0.45,0.94)",
        }}
      >
        <div className={`p-4 mt-4`}>
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <i class="ri-xrp-fill bg-black p-1 text-white"></i>
            </button>
          </div>
          {/* Cart Details */}
          <div className="cart-items">
            {products.length === 0 ? (
              ...
              products.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row md:items-center md:justify-between shadow-md
                md:p-5 p-2 mb-4"
                >
                  <div className="flex items-center">
                    ...
                    <div
                      className="flex flex-row md:justify-start justify-end
                    items-center mt-2"
                    >
                      <button
                        onClick={() => handleQuantity("decrement", item.id)}
                        className="size-6 flex items-center justify-center px-1.5
                      rounded-full bg-gray-200 text-gray-700 hover:bg-primary
